<div style="padding: 1px;">
    <!--<form id="drop_test_list_input_form" method="post" novalidate enctype="multipart/form-data" class="table_form">-->
    <form id="drop_test_list_input_form" method="post" novalidate class="table_form" enctype="multipart/form-data" >
        <table width="100%" border="0">

            <tr>
                <td width='30%'><strong>Drop Test Type</strong></td>
                <td>
                    <input class="easyui-combobox" 
                           id="drop_test_protocol_id"
                           name="protocol_test_id"
                           url="<?php echo site_url('protocol_test/get/Drop') ?>"
                           method="post"
                           mode="remote"
                           valueField="id"
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="purchaseorder_item_id" required="true" id="drop_test_list_po_item_id" class="easyui-combogrid" style="width:100%;"/>
                    <script>
...
<!--            <tr>
                ...
                <td>
                    <input class="easyui-combobox" 
                           id="drop_test_client_id"
                           name="drop_test_client_id"
                           url="<?php echo site_url('client/get') ?>"
                           method="post"
                           mode="remote"
                           valueField="id"
                           textField="name"
                           data-options="formatter: drop_test_client_format"
                           style="width: 100%" 
                           />
                </td>
            </tr>-->
