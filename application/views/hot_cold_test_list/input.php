<div style="padding: 1px;">
    <!--<form id="ho_test_list_input_form" method="post" novalidate enctype="multipart/form-data" class="table_form">-->
    <form id="ho_test_list_input_form" method="post" novalidate class="table_form" enctype="multipart/form-data" >
        <table width="100%" border="0">
            ...
            <tr>
                ...
                <td>
                    <input class="easyui-combobox" 
                           id="ho_test_protocol_id"
                           name="protocol_test_id"
                           url="<?php echo site_url('protocol_test/get/Hot_Cold%20Test') ?>"
                           method="post"
                           mode="remote"
                           valueField="id"
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="purchaseorder_item_id" required="true" id="ho_test_list_po_item_id" class="easyui-combogrid" style="width:100%;"/>
                    <script>

                        $('#ho_test_list_po_item_id').combogrid({
                            url: base_url + 'ho_test_list/get_item_po',
                            idField: 'valfield',
                            textField: 'myfield',
                            mode: 'remote',
                            columns: [[
...
<!--            <tr>
                ...
                <td>
                    <input class="easyui-combobox" 
                           id="ho_test_client_id"
                           name="ho_test_client_id"
                           url="<?php echo site_url('client/get') ?>"
                           method="post"
                           mode="remote"
                           valueField="id"
                           textField="name"
                           data-options="formatter: ho_test_client_format"
                           style="width: 100%" 
                           />
                </td>
            </tr>-->
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="vendor_id" required="true" id="ho_test_vendor_id" class="easyui-combogrid" style="width:100%;"/>
                    <script>

                        $('#ho_test_vendor_id').combogrid({
