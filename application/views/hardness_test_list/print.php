    ...
    <tbody>
        ...
        <tr>
            <td colspan="3" width="48%">
                <table  class="table-border-luar-dalam">
                    ...
                    <tr>
                        ...
                        <td width='2%' align='center'>:</td>
                        <td width='58%'><?php echo $hardness_test_list->ebako_code; ?></td>
                    </tr>
                    <tr>
            ...
            <td colspan="3" width="48%">
                <table  class="table-border-luar-dalam">
                    <tr>
                        <th colspan="3">hardness SPECIFICATION</th>
                    </tr>
                    <tr>
                        <td width='50%'>hardness Dimension (Inches)</td>
                        <td width='2%' align='center'>:</td>
                        <td width='58%'><?php echo $hardness_test_list->hardness_dimension; ?></td>
                    </tr>
                    <tr>
                            ...
                            <tr>
                                ...
                                <td align="center"  width="50%">
                                    ...
                                    if (trim($result->image2_file) != "") {
                                        $image2 = $_SERVER["HTTP_REFERER"] . 'files/hardnesstest/' . $result->hardness_test_list_id . "/" . $result->image2_file;
                                        echo "<img src='" . $image2 . "' width='175'>";
                                    }
                                    if (trim($result->image_file) != "") {
                                        $image3 = $_SERVER["HTTP_REFERER"] . 'files/hardnesstest/' . $result->hardness_test_list_id . "/" . $result->image3_file;
