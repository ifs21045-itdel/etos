                    ...
                    <tr>
                        <td height="100" width="500" align="center">
                            ...
                            if (trim($hot_cold_test_list->product_image) != "") {
                                $image = $_SERVER["HTTP_REFERER"] . 'files/producttest/' . $hot_cold_test_list->id . "/" . $hot_cold_test_list->product_image;
                               // echo $image;
                            ...
                            <tr>
                                ...
                                <td align="center"  width="50%">
                                    ...
                                    if (trim($result->image_file) != "") {
                                        $image = $_SERVER["HTTP_REFERER"] . 'files/producttest/' . $result->hot_cold_test_list_id . "/" . $result->image_file;
                                        echo "<img src='" . $image . "' width='175'>";
                                    }
                                    if (trim($result->image2_file) != "") {
                                        $image2 = $_SERVER["HTTP_REFERER"] . 'files/producttest/' . $result->hot_cold_test_list_id . "/" . $result->image2_file;
                                        echo "<img src='" . $image2 . "' width='175'>";
                                    }
                                    if (trim($result->image_file) != "") {
                                        $image3 = $_SERVER["HTTP_REFERER"] . 'files/producttest/' . $result->hot_cold_test_list_id . "/" . $result->image3_file;
