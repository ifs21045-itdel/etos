                ...
                <td colspan="3" width="48%">
                    <table class="table-border-luar">
                        <tr>
                            ...
                            <td colspan="2"d width='80%' ><?php echo $product_test_list->report_no; ?></td>
                        </tr>
                        <tr>
                            <td width='40%'>Test Date</td>
                            <td width='2%' align='center'>:</td>
                            <td width='80%' colspan="2"><?php echo date('d M Y', strtotime($product_test_list->test_date)); ?></td>
                        </tr>
                        <tr>
                            <td width='40%'>Report Date</td>
                            <td width='2%' align='center'>:</td>
                            <td width='80%' colspan="2"><?php echo date('d M Y', strtotime($product_test_list->report_date)); ?></td>
                        </tr>
                        <tr>
                            <td width='40%'>Type of Report</td>
                            <td width='2%' align='center'>:</td>
                            <td width='80%' colspan="2"><?php echo $product_test_list->protocol_name; ?></td>
                        </tr>
                    </table>
                </td>
                <td width="1%"></td>
                ...
                <td colspan="3" width="48%">
                  <table class="table-border-luar">
                        ...
                        <tr>
                            ...
                            <td width='2%' align='center'>:</td>
                            <td width='58%' colspan="2"><?php echo $product_test_list->client_name; ?></td>
                        </tr>
                        <tr>
                            <td width='40%'>Ebako Code</td>
                            <td width='2%' align='center'>:</td>
                            <td width='58%' colspan="2"><?php echo $product_test_list->ebako_code; ?></td>
                        </tr>
                        <tr>
                            <td width='40%'>Customer Code</td>
                            <td width='2%' align='center'>:</td>
                            <td width='58%' colspan="2"><?php echo $product_test_list->customer_code; ?></td>
                        </tr>
                        <tr>
                            <td width='40%'>Item Description</td>
                            <td width='2%' align='center'>:</td>
                            <td width='58%' colspan="2"><?php echo $product_test_list->item_description; ?></td>
                        </tr>
                    </table>
                </td>
                <td width="1%"></td>
