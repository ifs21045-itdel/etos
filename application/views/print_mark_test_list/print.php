                ...
                <td colspan="3" width="48%">
                    <table class="table-border-luar">
                        <tr>
                            ...
                            <td colspan="2"d width='80%' ><?php echo $print_mark_test_list->report_no; ?></td>
                        </tr>
                        <tr>
                            <td width='40%'>Test Date</td>
                            <td width='2%' align='center'>:</td>
                            <td width='80%' colspan="2"><?php echo date('d M Y', strtotime($print_mark_test_list->test_date)); ?></td>
                        </tr>
                        <tr>
                            <td width='40%'>Report Date</td>
                            <td width='2%' align='center'>:</td>
                            <td width='80%' colspan="2"><?php echo date('d M Y', strtotime($print_mark_test_list->report_date)); ?></td>
                        </tr>
                        <tr>
                            <td width='40%'>Type of Report</td>
                            <td width='2%' align='center'>:</td>
                            <td width='80%' colspan="2"><?php echo $print_mark_test_list->protocol_name; ?></td>
                        </tr>
                    </table>
                </td>
                <td width="1%"></td>
                    ...
                    <table class="table-border-luar">
                        ...
                        <tr>
                            ...
                            <td width='48%' align='center'>
                                <?php
                                if ($print_mark_test_list->rating == 'Passed')
                                    echo '<b>X</b>';
                                ?>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td width='48%' align='center'>
                                <?php
                                if ($print_mark_test_list->rating == 'Failed')
                                    echo '<b>X</b>';
                                ?>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td width='48%' align='center'>
                                <?php
                                if ($print_mark_test_list->rating == 'Car')
                                    echo '<b>X</b>';
                                ?>
                            </td>
                        </tr>
            ...
            <tr>
                <td colspan="3" width="48%">
                  <table class="table-border-luar">
                        ...
                        <tr>
                            ...
                            <td width='2%' align='center'>:</td>
                            <td width='58%' colspan="2"><?php echo $print_mark_test_list->client_name; ?></td>
                        </tr>
                        <tr>
                            <td width='40%'>Ebako Code</td>
                            <td width='2%' align='center'>:</td>
                            <td width='58%' colspan="2"><?php echo $print_mark_test_list->ebako_code; ?></td>
                        </tr>
                        <tr>
                            <td width='40%'>Customer Code</td>
                            <td width='2%' align='center'>:</td>
                            <td width='58%' colspan="2"><?php echo $print_mark_test_list->customer_code; ?></td>
                        </tr>
                        <tr>
                            <td width='40%'>Item Description</td>
                            <td width='2%' align='center'>:</td>
                            <td width='58%' colspan="2"><?php echo $print_mark_test_list->item_description; ?></td>
                        </tr>
                    </table>
                </td>
                <td width="1%"></td>
                <td colspan="3" width="48%">
                    ...
                    <tr>
                        ...
                        <td width='2%' align='center'>:</td>
                        <td width='58%'><?php echo $print_mark_test_list->product_dimension; ?></td>
                    </tr>
                    <tr>
                        <td width='50%'>Carton Dimension (Inches)</td>
                        <td width='2%' align='center'>:</td>
                        <td width='58%'><?php echo $print_mark_test_list->carton_dimension; ?></td>
                    </tr>
                    <tr>
                        <td width='50%'>Gross Weight (Lbs)</td>
                        <td width='2%' align='center'>:</td>
                        <td width='58%'><?php echo $print_mark_test_list->gross_weight; ?></td>
                    </tr>
                    <tr>
                        <td width='50%'>Nett  Weight (Lbs)</td>
                        <td width='2%' align='center'>:</td>
                        <td width='58%'><?php echo $print_mark_test_list->nett_weight; ?></td>
                    </tr>
                    </table>
                </td>
            </tr>
                    ...
                    <tr style="height: 384px;">
                        ...
                        <td width="50%" align="center" style="border: 1px solid #000; padding: 8px;" colspan="5">
                            ...
                            if (trim($result->image_file) != "") {
                                $image = $_SERVER["HTTP_REFERER"] . 'files/droptest/' . $result->print_mark_test_list_id . "/" . $result->image_file;
                               $width = 3 * 60;  
                                    $height = 4 * 60; 
                                    echo "<img src='" . $image . "' width='" . $width . "' height='" . $height . "' style='margin-top: 10px;' />";
